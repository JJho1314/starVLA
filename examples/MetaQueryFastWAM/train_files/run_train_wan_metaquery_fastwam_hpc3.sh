...
###############################################################################
# WanMetaQueryFastWAM on HPC3 (Wan2.2-TI2V + Qwen3-VL-guided cross-attn context).
# Reuses train_starvla.py — framework's forward/predict_action are inherited
# from Wan_FastWAM untouched; the only new logic is the monkey-patched
# backbone.build_inputs that appends VLM queries to encoder_hidden_states.
