#!/bin/bash
#SBATCH --job-name=starvlm-qwen3vl4b
...
#SBATCH --output=/data/user/jhe724/workspace/starVLA/playground/Checkpoints/starvlm_%j.out
#SBATCH --error=/data/user/jhe724/workspace/starVLA/playground/Checkpoints/starvlm_%j.err
...
# Symlink the dataset path the YAML/qwen_data_config.py expects
mkdir -p playground/Datasets
[ -L playground/Datasets/LLaVA-OneVision-COCO ] || ln -s /data/user/jhe724/workspace/data/LLaVA-OneVision-COCO playground/Datasets/LLaVA-OneVision-COCO
...
export WANDB_PROJECT="starVLA_VLM"

bash examples/CoTrainVLM/train_files/run_starvlm_hpc3.sh
